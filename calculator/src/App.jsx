...
export const ACTIONS = {
    ADD_DIGIT: 'add-digit',
    CHOOSE_OPERATTION: 'choose-operations',
    CLEAR: 'clear',
...
switch (type){
    ...
    case ACTIONS.CHOOSE_OPERATTION:
        ...
        if(state.previousOperand== null) {
            ...
            return {
                ...state,
                operation:payload.operation,previousOperand: evaluate(state.previousOperand,state.currentOperand,state.operation),currentOperand:null
            }
